...
8. 设定Vpon进入您的聚合列表： <br>
(1) 在可用的广告联播网中找到 Vpon <br>
(2) Vpon Ad Id: 填入您在 Vpon 后台申请的 License Key <br>
(3) Zone: 选择您欲请求的广告平台的地区，请填写 "TW" <br>
...
利用以下五个步骤新增出一个横幅广告: <br>
• 汇入 com.google.android.gms.ads.* <br>
• 宣告一个 AdView物件 <br>
• 建立并指定一个 ad unit ID <br>
• 在使用者介面中新增 view <br>
• 取得banner <br>
