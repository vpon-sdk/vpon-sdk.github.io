...
# 總覽
---
Vpon Mobile Web SDK 提供 Adhesion Banner，讓橫幅廣告可黏著於行動裝置的螢幕下方，讓我們精準投放的廣告更能讓使用者所觀看，以提升廣告收益。<br>
...
# 嵌入廣告程式碼
---
1. 與一般 Web Banner 相似，同樣在行動網頁的 <body> 中填入 <vpon> tag，唯一不同點在於當 <vpon> tag 中包含了 vpon_ad_isBottom 的屬性且其為 "true" 時，可自動將該廣告黏著於行動裝置的螢幕下方。在網頁 <body> 內預放廣告的位置加上以下程式碼：
