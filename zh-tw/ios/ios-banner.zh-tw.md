...
3. 建立 VpadnBanner 物件，並指定 License ID
4. 拉取廣告
...
## 建立 VpadnBanner 物件
---
請參考以下程式碼，在 ViewController 的 viewDidLoad 中初始化橫幅廣告，並指定 License ID
...
- (void)viewDidLoad {
  ...
  vpadnBanner.strBannerId = @""; // 填入您的 License ID for Banner AD
