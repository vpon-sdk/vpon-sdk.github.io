...
# 申請 License ID
---
串接不同平台、不同類型的廣告，需要使用不同的 License ID，在進行廣告串接之前，請務必為您的應用程式取得 License ID。
<!-- 我們強烈建議您同時註冊「台灣區」以及「中國區」的 License
Key，可以幫助您橫跨大中華區的行動廣告市場。 -->

請登入[開發商後台]申請 License ID。
...
進入版位列表頁面後，您將會看見您的版位審核狀態與應用程式的 License ID。按下左選單的【軟體列表】進入軟體列表頁面。
![][2]
