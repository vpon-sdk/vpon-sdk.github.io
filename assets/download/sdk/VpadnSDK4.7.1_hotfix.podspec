...
SDK Document: http://vpon-sdk.github.io/ios/ 
  ...
  s.author           = 'Vpon Inc'
  s.authors          = 'Vpon Inc.'
  s.source           = {http: 'http://vpon-sdk.github.io/assets/download/sdk/VpadnSDKiOS-4.7.1_hotfix.zip'}
  # s.social_media_url = 'https://www.facebook.com/VponInc'

  s.ios.deployment_target = '7.0'
  s.ios.preserve_paths = 'VpadnSDKiOS-4.7.1_hotfix'
  s.ios.vendored_frameworks = 'VpadnSDKiOS-4.7.1_hotfix/VpadnSDKAdKit.framework'
